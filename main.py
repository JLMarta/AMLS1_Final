...
basedir_tr = './Dataset/dataset_AMLS_22-23/cartoon_set'
...
basedir_te = './Dataset/dataset_AMLS_22-23_test/cartoon_set_test'
...
# Get data for B2
X_train = B2_feature(len = 10000, path = 'Dataset/dataset_AMLS_22-23/cartoon_set/img/')
X_test = B2_feature(len = 2500, path = 'Dataset/dataset_AMLS_22-23_test/cartoon_set_test/img/')
y_train_color = B2_label(path = 'Dataset/dataset_AMLS_22-23/cartoon_set/labels.csv')
y_test_color = B2_label(path = 'Dataset/dataset_AMLS_22-23_test/cartoon_set_test/labels.csv')
normlisor = StandardScaler()
# Test model for B2
X_train = normlisor.fit_transform(X_train)
X_test = normlisor.fit_transform(X_test)
